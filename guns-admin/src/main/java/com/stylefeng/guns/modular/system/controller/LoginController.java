...
import com.stylefeng.guns.common.aes.AesEncryptUtil;
...
public class LoginController extends BaseController {
    ...
    public String loginVali() {
        ...
        String passwordAes = super.getPara("password").trim();
        // rsa加密效率太低
        /*String passwordRSA = super.getPara("password").trim();
        String password = RSAUtil.dealRsaPwd(passwordRSA);*/

        // ase 加密
        String password = "";
        try {
            password = AesEncryptUtil.desEncrypt(passwordAes);
        } catch (Exception e) {
            throw new InvalidKaptchaException();
        }
        String remember = super.getPara("remember");
        //super.getSession().setAttribute("loginUsername", username);
