...
public class ContextConfig {
    ...
    public String getsEntityName() {
        String sEntityNameT = toLowerFirst(entityName);
        this.sEntityName = sEntityNameT;
        return sEntityName;
    }
    ...
    public String getSmallServiceName() {
        this.smallServiceName = bizEnName;
        return smallServiceName;
    }

    public void setSmallServiceName(String smallServiceName) {
        this.smallServiceName = smallServiceName;
    }
