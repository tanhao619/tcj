...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        gc.setOutputDir("E:\\tcj\\guns-admin\\src\\main\\java");//这里写你自己的java目录,到guns-admin
        gc.setFileOverride(false);//是否覆盖
        gc.setActiveRecord(true);
        gc.setEnableCache(false);// XML 二级缓存
        gc.setBaseResultMap(true);// XML ResultMap
        gc.setBaseColumnList(false);// XML columList
        gc.setAuthor("lgg");// 自己的名字
        ...
        //strategy.setInclude(new String[]{"govaff_app_app"});// 需要生成的表
        strategy.setInclude(new String[]{"pro_adviseOpeType","pro_contractType"});
        /*strategy.setInclude(new String[]{"export_config","follow_project","normal_project","pro_area","pro_attachment",
                "pro_company","pro_convention","pro_history","pro_talk","unit_liable"});// 需要生成的表*/
