...
var start2 = {
    ...
    choosefun: function (elem, datas,val) {
        ...
        endDatesOa();
        WorkflowInfoDlg.qjAMPM();
         qjDays();
        // logTable.draw();

    },
    okfun: function (element,val) {
        WorkflowInfoDlg.qjAMPM();
        qjDays();
        // logTable.draw();
    },
...
var end2 = {
    ...
    clearfun: function () {
        start2.maxDate =  '2099-06-16 23:59:59';
        WorkflowInfoDlg.qjAMPM();
        qjDays();
        // logTable.draw();
    }
};
function timeBetweenOa(startTimeId,endTimeId) {
    endTimeIdT = endTimeId;
    startTimeId.jeDate(start2);
    endTimeId.jeDate(end2);
}
function endDatesOa() {
    end2.trigger = false;
    endTimeIdT.jeDate(end2);
}
function endDates() {
    end.trigger = false;
