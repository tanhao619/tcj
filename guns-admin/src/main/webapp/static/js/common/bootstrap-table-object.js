...
(function () {
 ...
 /*                   responseHandler:function (res) {
    ...
    // 自定义分页条数 lgg加
    var BSTablePG = function (bstableId, url, columns,limit) {
        this.btInstance = null;					//jquery和BootStrapTable绑定的对象
        this.bstableId = bstableId;
        this.url = Feng.ctxPath + url;
        //this.method = "post";
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    sortOrder: "desc",     		//排序方式
                    pageNumber: 1,      			//初始化加载第一页，默认第一页
                    pageSize: limi,      			//每页的记录行数（*）
                    //pageList: [limi, 2*limi, 4*limi],  	//可供选择的每页的行数（*）
                    pageList: [limi, 2*limi],
                    queryParamsType: 'limit', 	//默认值为 'limit' ,在默认情况下 传给服务端的参数为：offset,limit,sort
                    queryParams: function (param) {
                        return $.extend(me.queryParams, param);
                    }, // 向后台传递的自定义参数
    ...
    window.BSTablePG = BSTablePG;
   //获取总数据条数
    var BSTableTotal = function (bstableId, url, columns) {
        this.btInstance = null;					//jquery和BootStrapTable绑定的对象
        this.bstableId = bstableId;
        this.url = Feng.ctxPath + url;
        //this.method = "post";
    ...
    window.BSTableTotal = BSTableTotal;
    ...
    // add by cc
    var BSTableCC = function (bstableId, url, columns) {
        this.btInstance = null;					//jquery和BootStrapTable绑定的对象
        this.bstableId = bstableId;
        this.url = Feng.ctxPath + url;
        //this.method = "post";
    ...
    BSTableCC.prototype = {
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    detailView:true,
                    // detailFormatter:detailOpen(index,row),
        ...
        setDetailFormatter : function(rDiv){
            this.detailFormatter=rDiv;
        },
        /**
         * 设置分页方式：server 或者 client
         */
    ...
    // add by FYC
    //获取总数据条数
    var BSTableTotalPG = function (bstableId, url, columns,limit) {
        this.btInstance = null;					//jquery和BootStrapTable绑定的对象
        this.bstableId = bstableId;
        this.url = Feng.ctxPath + url;
        //this.method = "post";
        ...
        init: function () {
            ...
            this.btInstance =
                $('#' + tableId).bootstrapTable({
                    ...
                    pageList: [limit, 2*limit,3*limit],  	//可供选择的每页的行数（*）
                    queryParamsType: 'limit', 	//默认值为 'limit' ,在默认情况下 传给服务端的参数为：offset,limit,sort
                    queryParams: function (param) {
                        return $.extend(me.queryParams, param);
                    }, // 向后台传递的自定义参数
    ...
    window.BSTableTotalPG = BSTableTotalPG;
