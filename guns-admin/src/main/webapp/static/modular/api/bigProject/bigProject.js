...
BigProject.initColumn = function () {
    return [
        ...
        {title: '项目更新时间', field: 'updateTime', visible: true, align: 'center', valign: 'middle', sortable: true,width:'22%'}
    ];
};
