...
ZateInfoDlg.collectData2 = function() {
    // 添加自己需要新增的字段信息，与新增页面的input框的id相匹配,如 this.set('id').set('name').set()..
    this.set2('name').set2('address').set2('area').set2('property').set2('status').set2('unit').set2('fillTime').set2('fillContacter').set2('fillTel')
    ...
    this.zateInfoData2.induType = $(".induType:checked").val();
    }
};
