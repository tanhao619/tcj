...
$(function() {
    ...
    var category = $("input[name='category'][type='hidden']").val();
    $("input[name='category'][type='radio']")[category-1].checked=true;
    $("input[name='category'][type='radio']")[category-1].parentNode.classList.add("active");
