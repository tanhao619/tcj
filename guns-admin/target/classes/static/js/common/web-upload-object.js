...
(function() {
	...
	var $WebUpload = function(pictureId) {
		this.pictureId = pictureId;  /*页面上封装avatar的ID*/
		this.uploadBtnId = pictureId + "BtnId";  /*上传按钮的ID*/
		this.uploadPreId = pictureId + "PreId";  /*图片缩略框ID*/
		this.uploadUrl = Feng.ctxPath + '/mgr/upload'; /*上传地址*/
	...
	$WebUpload.prototype = {
		...
		bindEvent : function(bindedObj) {
			...
			bindedObj.on('fileQueued', function(file) {
				var showListWarp=$("#fileList");
				var item="<button>删除</button><button>查看</button>"
				showListWarp.append(item);
				console.log("ok")
			});
